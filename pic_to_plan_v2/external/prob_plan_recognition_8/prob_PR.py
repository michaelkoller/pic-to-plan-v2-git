...
def main() :
	print(sys.argv)
	#['/home/mk/PycharmProjects/pic-to-plan-v2-git/pic_to_plan_v2/prob-plan-recognition/prob_PR.py', '-G', '-e', '/home/mk/PycharmProjects/pic-to-plan-v2-git/pic_to_plan_v2/observation_trace_gen/sample.tar.bz2']

	options = Program_Options( sys.argv[1:])
	#options = Program_Options( ['-G', '-e', '/home/mk/PycharmProjects/pic-to-plan-v2-git/pic_to_plan_v2/observation_trace_gen/sample.tar.bz2'])
