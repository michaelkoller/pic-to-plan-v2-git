...
(:action cut
    :parameters(?o ?k)
    :precondition (and (knife ?k) (exists (?h - hand) (and (in_hand ?k ?h))))
    :effect (active ?o)
)
;end actions
