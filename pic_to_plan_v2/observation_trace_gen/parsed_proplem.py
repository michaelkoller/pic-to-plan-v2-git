...
class ParsedPDDLProblem:
    def __init__(self, domain_path, instance_path, ontology_path):
        ...
        # TODO
        # all the predicates that indicate a type of object must be defined in a simple conjunctive way in the
        # precondition of an action in the template-domain.
        # e.g., (and (graspable ?o))
        # in formulations like (and (knife ?k) (exists (?h) (and (manipulator ?h) (in_hand ?k ?h)))), then manipulator
        # will not be added (and here it is indeed not nec as well)
